        ...
        <article>
          ...
          <div className="news-para">
            ...
            <p>
              ...
              type and scrambled it to make a type specim book. It has survived
              not only five <strong>gravida</strong> but also the leap into
              electronic typesetting, remaining essentially unchange was
              popularised in the 1960s with the release of Letraset sheets
              containing Lorem Ipsum <a href="index.html">Ipsum</a> and more
              recently with desktop publishing software like Aldus src=" maker
          ...
          <div className="news-para">
            <h5>
              Mastering Digital Transformation: How to Stay Ahead in a Rapidly
            ...
            <p>
              ...
              <strong>adipisicing</strong> of Lorem Ipsum, you need to be sure
          ...
          <blockquote className="wp-block-quote">
            ...
            <p>
              “ People find waiting more tolerable when they can see the work
          ...
          <div className="news-para">
            <p>
              ...
              typesetting, remaining essentially unchange was popularised in the
            ...
            <ol>
              ...
              <li>
                Gravida neque convallis a <strong>cras</strong> semper auctor
                neque vitae.
              </li>
            ...
            <p>
              ...
              culpa reprehenderit ad ipsa porro obcaecati accusantium tempore
              officiis tenetur est!
            </p>
          </div>
        </article>
              ...
              <div className="news-card-one">
                ...
                <div className="news-card-info">
                  ...
                  <ul className="news-metainfo list-style">
                    <li>
                      <i className="fi fi-rr-calendar-minus" />
                      <a href="news-by-date.html">Apr 03, 2023</a>
                    </li>
                  </ul>
                </div>
              </div>
              <div className="news-card-one">
                ...
                <div className="news-card-info">
                  ...
                  <ul className="news-metainfo list-style">
                    <li>
                      <i className="fi fi-rr-calendar-minus" />
                      <a href="news-by-date.html">Apr 01, 2023</a>
                    </li>
                  </ul>
                </div>
              </div>
